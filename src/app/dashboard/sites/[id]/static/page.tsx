...
export default async function StaticPage({params}: {params:Promise<{id:string}>}) {
 ...
 return <main className="ui-page"><LegacySiteSection siteId={id} section="static" fallback={destination}/><Link className="ui-btn" href={destination}>Abrir configurações do Webflow</Link></main>;
}
