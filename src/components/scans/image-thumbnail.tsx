...
export function ImageThumbnail({ url, alt }: { url: string; alt: string }) {
  ...
  if (failedUrl === url) return <span className="flex h-14 w-14 shrink-0 items-center justify-center rounded border bg-subtle text-center text-[10px] text-faint">Sem prévia</span>;
