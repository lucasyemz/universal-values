...
function Extension() {
  ...
  return <main>
    ...
    {!home && <section><h2>Conecte sua conta</h2><p>Autorize este site no dashboard e cole o código temporário aqui. Prévia, confirmação e resultado serão registrados no seu workspace.</p>
      ...
      </form><p className="muted">A sessão dura até 30 dias e pode ser revogada no dashboard. Nenhuma alteração é aplicada ao conectar.</p>
    </section>}
    {home && view === "home" && <>
