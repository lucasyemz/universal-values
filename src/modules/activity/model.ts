...
export const changeRow = z.object({ id: z.uuid(), site_id: z.uuid(), status: z.string(), cursor: z.number(), total: z.number(), background_paused: z.boolean(), scan_id: z.string().nullish(), managed_value_id: z.string().nullable(), results: z.array(z.object({ status: z.string() }).passthrough()) });
